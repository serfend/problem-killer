...
describe('Utils:validate', () => {
  ...
  it('validURL', () => {
    expect(validURL('https://github.com/serfend/vue-element-admin')).toBe(true)
    expect(validURL('http://github.com/serfend/vue-element-admin')).toBe(true)
    expect(validURL('github.com/serfend/vue-element-admin')).toBe(false)
  })
  it('validLowerCase', () => {
